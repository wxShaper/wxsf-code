...
{
	wxMessageBox(wxString::Format(wxT("ShapeFramework Demonstration Application v1.5.1\nwxShapeFramework version number: %s\nMichal Bližòák (c) 2007"), m_DiagramManager.GetVersion().c_str()), wxT("ShapeFranework"));
}
