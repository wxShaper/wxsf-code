...
.\ReleaseDLL	- DLL-based executable and relevant DLLs of wxShapeFramework demo app

All binaries have been built with GCC 3.4.5 and unicode release of wxWidgets 2.8.3.p1 (both static and dynamic link).

Note:
-----

This package do not allow building of user applications based on wxSF. To do this you must download source files package that includes both library source code files and the demo application source files as well.
