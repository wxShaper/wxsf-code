...
!ifeq WX_SHARED 0
__wxsf_lib___depname = &
	..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib
!endif
__wxsf_dll___depname =
!ifeq WX_SHARED 1
__wxsf_dll___depname = &
	..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.dll
!endif
____wxsf_3 =
!ifeq WX_SHARED 0
____wxsf_3 = lib
...
WXSF_LIB_CXXFLAGS = $(____WX_SHARED) $(__WXUNICODE_DEFINE_p) &
	...
	$(VAR_6) -wx -i=..\include -i=..\src $(CPPFLAGS) $(CXXFLAGS)
WXSF_LIB_OBJECTS =  &
	...
	watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxsf_lib_ScaledPaintDC.obj &
...
WXSF_DLL_CXXFLAGS = -bd $(____WX_SHARED) $(__WXUNICODE_DEFINE_p) &
	$(__WXDEBUG_DEFINE_p) -d__WXMSW__ &
	-i=$(WX_DIR)$(WXLIBPATH)\msw$(WXLIBPOSTFIX) -i=$(WX_DIR)\include $(VAR) &
	$(VAR_6) -wx -i=..\include -dWXMAKINGDLL_WXSF -i=..\src -dWXMAKINGDLL_WXXS &
	$(CPPFLAGS) $(CXXFLAGS)
WXSF_DLL_OBJECTS =  &
	...
	watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxsf_dll_ScaledPaintDC.obj &
...
clean : .SYMBOLIC 
	...
	-if exist ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib del ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib
	-if exist ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.dll del ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.dll
	-if exist ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib del ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib
...
!ifeq WX_SHARED 0
..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib :  make_dir_wxsf_lib  $(WXSF_LIB_OBJECTS)
...
make_dir_wxsf_lib :  
	if not exist ..\lib\wat_$(____wxsf_3) mkdir ..\lib\wat_$(____wxsf_3)

!ifeq WX_SHARED 1
..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.dll :  make_dir_wxsf_dll  $(WXSF_DLL_OBJECTS)
	...
	wlib -q -n -b ..\lib\wat_$(____wxsf_3)\wxcode_msw$(WX_VERSION)$(WXLIBPOSTFIX)_wxsf.lib +$^@
!endif
...
watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxsf_lib_ScaledPaintDC.obj :  .AUTODEPEND ..\src\ScaledPaintDC.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXSF_LIB_CXXFLAGS) $<
...
watmsw$(WXLIBPOSTFIX)$(_BUILDDIR_SHARED_SUFFIX)\wxsf_dll_ScaledPaintDC.obj :  .AUTODEPEND ..\src\ScaledPaintDC.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXSF_DLL_CXXFLAGS) $<
